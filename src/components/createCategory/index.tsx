...
const PersonalHome = () => {
  ...
  return (
    <article className="rounded-lg border border-gray-100 p-4 shadow-sm transition hover:shadow-lg dark:border-gray-800 dark:shadow-gray-700/25 sm:p-6">
      <span className="inline-block rounded bg-teal-600 p-2 text-white dark:bg-teal-700">
        <svg
