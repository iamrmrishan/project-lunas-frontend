...
<div className="col-span-3">
          ...
          <div className="p-4 my-4 border rounded  border-primaryText  dark:border-secondaryText border-opacity-10 dark:border-opacity-10">
            ...
            <div className="my-5">
              <ReactQuill theme="snow" value={value} onChange={setValue} onFocus={() => setShow(prev => !prev)} />
            </div>
            <div>
              <button>Next</button>
            </div>
...
<div hidden={show} className="p-4 my-4 border rounded  border-primaryText  dark:border-secondaryText border-opacity-10 dark:border-opacity-10">
  hi
